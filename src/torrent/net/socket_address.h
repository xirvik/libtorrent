...
bool sa_is_private(const sockaddr* sa) LIBTORRENT_EXPORT;
bool sin_is_private(const sockaddr_in* sa) LIBTORRENT_EXPORT;
bool sin6_is_private(const sockaddr_in6* sa) LIBTORRENT_EXPORT;
